...
from .zoo import ColModernVBertModel, ColModernVBertConfig 
...
def load_model(model_name=None, model_path=None, **kwargs):
    ...
    if model_path is None:
        model_path = "ModernVBERT/colmodernvbert"
    
    config_dict = {"model_path": model_path}
    config_dict.update(kwargs)
    
    config = ColModernVBertConfig(config_dict)
    return ColModernVBertModel(config)
